...
alias wget='wget --hsts-file="$XDG_CACHE_HOME/wget/wget-hsts"' # wget
...
NODE_REPL_HISTORY="$XDG_DATA_HOME/nodejs/node_repl_history" # node.js
...
SQLITE_HISTORY="$XDG_DATA_HOME/sqlite3/sqlite_history" # SQLite
WGETRC="$XDG_CONFIG_HOME/wget/wgetrc" # wget
#XAUTHORITY="$XDG_RUNTIME_DIR/Xauthority" # xorg-xauth
XINITRC="$XDG_CONFIG_HOME/X11/xinitrc" # X11
XSERVERRC="${XDG_CONFIG_HOME}"/X11/xserverrc # X11
